			...
			<div className="mx-auto flex  max-w-7xl flex-col-reverse  items-center  gap-6 md:justify-center lg:flex-row ">
				...
				<div className="relative flex flex-col justify-center text-center lg:text-left">
					...
					<div className="flex flex-col items-center justify-center text-center lg:w-[519px]">
						<h2 className="mb-2  text-[32px] font-bold leading-[44px] text-[#8B4513] sm:text-[40px] sm:leading-[56px] md:text-[48px] md:leading-[64px] lg:mb-4 lg:text-[64px] lg:leading-[91px]">
							CUSTOMER FEEDBACK
						</h2>
					...
					<div className="mx-auto hidden w-full max-w-md rounded-[16px] bg-[#FFF1E1] px-4 py-4 sm:max-w-lg md:block md:max-w-md lg:w-[619.45px]  lg:rounded-[25px] lg:px-6 lg:py-4">
						<p className=" text-[14px] leading-[22px] text-black sm:text-[15px] sm:leading-[24px] md:text-[18px] md:leading-[28px] lg:text-[28px] lg:leading-[38px] ">
